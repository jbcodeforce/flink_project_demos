...
-- Migrated from dml.c360_fct_customer_profile.sql
WITH support_summary AS (
    ...
    FROM {{ ref('src_c360_support_ticket') }}
...
transaction_metrics AS (
 SELECT 
    ...
    FROM {{ ref('dim_c360_customer_transactions') }}
...
LEFT JOIN {{ ref('src_c360_loyalty_program') }} lp ON c.customer_id = lp.customer_id
