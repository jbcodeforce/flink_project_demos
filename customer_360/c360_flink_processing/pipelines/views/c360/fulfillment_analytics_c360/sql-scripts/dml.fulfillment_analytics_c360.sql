-- View: Fulfillment Analytics C360 Data Product
...
-- Dependencies: c360_fct_order_fulfillment
INSERT INTO fulfillment_analytics_c360
SELECT
    shipment_id,
    transaction_id,
    customer_id,
...
FROM c360_fct_order_fulfillment
