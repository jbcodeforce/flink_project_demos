with expected_results as (
    select 
    'customer_id' as expected_customer_id,    
    'first_name' as expected_first_name,    
    'last_name' as expected_last_name,    
    'email' as expected_email,    
    'customer_segment' as expected_customer_segment,    
    'preferred_channel' as expected_preferred_channel,    
    'generation_segment' as expected_generation_segment,    
    'age_years' as expected_age_years,    
    'days_since_registration' as expected_days_since_registration,    
    'city' as expected_city,    
    'state' as expected_state,    
    'country' as expected_country,    
    'loyalty_tier' as expected_loyalty_tier,    
