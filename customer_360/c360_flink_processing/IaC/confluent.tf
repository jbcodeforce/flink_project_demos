...
resource "confluent_environment" "c360_env" {
  count = var.existing_environment_id == null && var.existing_environment_name == null ? 1 : 0
...
locals {
  environment_id = var.existing_environment_id != null ? var.existing_environment_id : (
    var.existing_environment_name != null ? data.confluent_environment.env_by_name[0].id : confluent_environment.c360_env[0].id
  )
  environment_name = var.existing_environment_name != null ? var.existing_environment_name : (
    var.existing_environment_id != null ? data.confluent_environment.env_by_id[0].display_name : confluent_environment.c360_env[0].display_name
  )
  environment_resource_name = var.existing_environment_id != null ? data.confluent_environment.env_by_id[0].resource_name : (
    var.existing_environment_name != null ? data.confluent_environment.env_by_name[0].resource_name : confluent_environment.c360_env[0].resource_name
  )
}
